...
import com.example.sharkey.foodles.FireBaseDemonstration.HomeActivity;
...
public class CameraFragment extends Fragment implements View.OnClickListener,
    ...
    private void uploadFromUri(Uri fileUri) {
        ...
        final StorageReference photoRef = mStorageRef.child(user.getProviderId())
