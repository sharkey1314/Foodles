...
public class FeedItemAnimator extends DefaultItemAnimator {
    ...
    public boolean animateAdd(RecyclerView.ViewHolder viewHolder) {
        if (viewHolder.getItemViewType() == FeedAdapterV2.VIEW_TYPE_DEFAULT) {
            if (viewHolder.getLayoutPosition() > lastAddAnimatedItem) {
                lastAddAnimatedItem++;
                runEnterAnimation((FeedAdapterV2.CellFeedViewHolder) viewHolder);
                return false;
            }
        }
    ...
    private void runEnterAnimation(final FeedAdapterV2.CellFeedViewHolder holder) {
...
/*
    ...
    public boolean animateChange(@NonNull RecyclerView.ViewHolder oldHolder,
        ...
        if (preInfo instanceof FeedItemHolderInfo) {
            ...
            FeedAdapterV2.CellFeedViewHolder holder = (FeedAdapterV2.CellFeedViewHolder) newHolder;

            animateHeartButton(holder);
            updateLikesCounter(holder, holder.getFeedItem().getLikes_count().intValue());
            if (FeedAdapterV2.ACTION_LIKE_IMAGE_CLICKED.equals(feedItemHolderInfo.updateAction)) {
    ...
    /*private void animateHeartButton(final FeedAdapterV2.CellFeedViewHolder holder) {
    ...
    private void updateLikesCounter(FeedAdapterV2.CellFeedViewHolder holder, int toValue) {
    ...
    private void animatePhotoLike(final FeedAdapterV2.CellFeedViewHolder holder) {
...
*/
    private void dispatchChangeFinishedIfAllAnimationsEnded(FeedAdapterV2.CellFeedViewHolder holder) {
    ...
    /*private void resetLikeAnimationState(FeedAdapterV2.CellFeedViewHolder holder) {
